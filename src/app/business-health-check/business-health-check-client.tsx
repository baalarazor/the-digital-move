            ...
            <Card className="border-blue-100">
              ...
              <CardContent>
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6 text-center">
                  <p className="text-4xl font-semibold text-slate-950 sm:text-5xl">{score} / 100</p>
                  <p className="mt-3 inline-flex items-center rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-sm font-medium text-blue-700">
                ...
                <div className="mt-8">
                  ...
                  <ul className="mt-3 space-y-2">
                    {recommendations.map((service) => (
                      <li key={service} className="flex items-center rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700">
                ...
                <div className="mt-8 rounded-xl border border-blue-100 bg-blue-50/80 p-5">
